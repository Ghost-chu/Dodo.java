package net.deechael.dodo.configuration;

import net.deechael.dodo.configuration.serialization.ConfigurationSerializable;
...
import static net.deechael.dodo.utils.NumberConversions.*;
